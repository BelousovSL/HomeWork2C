...
-- DROP INDEX IF EXISTS public."IX_trainings_TrainingProgramId";
...
-- DROP INDEX IF EXISTS public."IX_client_trainings_ClientId";
...
-- DROP INDEX IF EXISTS public."IX_client_trainings_TrainingId";
